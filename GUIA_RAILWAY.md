...
## PASO 4: Variables de Entorno y Puerto
Tu aplicación usa un puerto por defecto, pero Railway asignará uno automáticamente en la variable `PORT`.
*   **Si Railway te pide un puerto** (por ejemplo, al generar el dominio o en Networking): Pon **3000**.
*   Tu código ya está listo para esto: `const PORT = process.env.PORT || 3000;`
